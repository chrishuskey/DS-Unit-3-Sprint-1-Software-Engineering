...
- What, in your opinion, is an important part of code reviews? That is, what is
  ...
  Answer: (1) Comments!: Clear comments throughout, that explain what major functions, etc. do, and used frequently enough that I don't need to spend >5 min. deciphering what any individual function is actually for (intended to do)...

- We have an awful lot of computers here, and it gets pretty confusing with
  slightly different things running on all of them. How could containers help us
  improve this situation?

  Answer: Putting everything in containers and running everything from containers would eliminate different performance/results across each different hardware device (due to hardware differences and also software differences, e.g. different OS's, different versions of Python), because everything needed is included in the container (essentially a mini- standalone OS that includes all packages needed to run a program on any hardware device).
